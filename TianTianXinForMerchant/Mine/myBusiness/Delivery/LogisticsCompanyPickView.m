...
@interface LogisticsCompanyPickView()<UIPickerViewDelegate,UIPickerViewDataSource>



@end

@implementation LogisticsCompanyPickView
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    if ([self.pickerdelegate respondsToSelector:@selector(bankPickerView:finishPickbankName:bankId:)]) {
        [self.pickerdelegate bankPickerView:pickerView finishPickbankName:dic[@"bankName"] bankId:dic[@"bankId"]];
    }
}
