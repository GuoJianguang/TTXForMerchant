...
- (void)drawTitle
{
    if (!_topTitle)
    {
        ...
        _topTitle.bounds = CGRectMake(0, 84, 145, 60);
...
- (void)drawBottomItems
{
    ...
    self.bottomItemsView = [[UIView alloc]initWithFrame:CGRectMake(0, THeight - 100,
...
- (void)showNextVCWithScanResult:(LBXScanResult*)strResult
{
    ...
    NSDictionary *info = @{@"phone":strResult.strScanned};
    [[NSNotificationCenter defaultCenter]postNotificationName:@"scanResultSuccess" object:nil  userInfo:info];
