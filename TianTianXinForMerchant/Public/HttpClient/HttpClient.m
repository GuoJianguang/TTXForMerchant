...
+(void)addTokenWithParameter:(NSMutableDictionary *)parameters manager:(AFHTTPRequestOperationManager*)manager {
    ...
    //[manager.requestSerializer setValue:[UserInfor sharedUserInfor].token forHTTPHeaderField:@"Authorization"];
}
...
+(AFHTTPRequestOperationManager*) manager:(AFHTTPRequestOperationManager*)manager addSignAndKeyWithParameter:(id)parameters {
