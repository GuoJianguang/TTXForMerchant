...
static float orgionWith = 80;


- (instancetype)initWithFrame:(CGRect)frame
{
    
    frame.size = CGSizeMake(orgionWith, orgionWith);
...
//    CGPathAddLineToPoint(tickPath, NULL, 39, 20);
    ...
    CGPathMoveToPoint(tickPath, NULL, 80.*(15/52.), 80.*(29/52.));
    CGPathAddLineToPoint(tickPath, NULL, 80.*(22/52.), 80.*(36/52.));
    CGPathAddLineToPoint(tickPath, NULL, 80.*(39/52.), 80.*(20/52.));
    return tickPath;
}
